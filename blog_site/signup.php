        ...
        <div class="signup">
            ...
            <form action="" method="POST">
                ...
                <label>
                    ...
                    I agree to Farmacy's <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a>
                </label>
                ...
                <div class="sign-in">
                    <div class="input-container social-signin google-signin">
                        ...
                        <input type="text" placeholder="Sign up with Google" readonly>
                    </div>
                    <div class="input-container social-signin apple-signin">
                        <i class="fab fa-apple"></i>
                        <input type="text" placeholder="Sign up with Apple" readonly>
                    </div>
                </div>
            </form>
        </div>
